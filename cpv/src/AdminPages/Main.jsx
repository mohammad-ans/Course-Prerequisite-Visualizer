...
export default function Main(){
    const [data, setData] = useState(["Add Course", "Delete Course", "Update Course", "See Pre-requisite Graph"]);
    const [links, setLinks] = useState(["addcourse", "delcourse", "updatecourse", "/graph"]);
